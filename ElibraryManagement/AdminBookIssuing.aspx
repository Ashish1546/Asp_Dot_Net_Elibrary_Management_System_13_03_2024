         ...
         <div class="col-md-5">
            <div class="card shadow">
               <div class="card-body">                
                  ...
                  <div class="row">
                      <div class="col-6 ">
                          <asp:Button CssClass="btn btn-lg btn-block btn-primary" ID="Button3" runat="server" Text="Issue" OnClick="Button3_Click" />
                      </div>
                      <div class="col-6 ">
                          <asp:Button CssClass="btn btn-lg btn-block btn-success" ID="Button4" runat="server" Text="Return" OnClick="Button4_Click" />
                      </div>
                  </div>
          ...
          <div class="col-md-7">
              <div class="card shadow">
                  <div class="card-body">                      
                      ...
                      <div class="row">
                          <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ELibrary_DBConnectionString %>" SelectCommand="SELECT * FROM [book_issue_tbl]"></asp:SqlDataSource>
                          <div class="col">
