            ...
            <div class="card shadow">
               <div class="card-body">                
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                            <img src="book_inventory/books1.png" id="imgview" height="150px" width=100px" />                         
                        </center>
                     </div>
                  </div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox6" runat="server" placeholder="Book Cost(per unit)" TextMode="Number" ReadOnly="True"></asp:TextBox>
                        </div>
                     </div>
                     <div class="col-md-4">
                  ...
                  <div class="row">
                     <div class="col-12">
                        <label>Book Description</label><asp:TextBox CssClass="form-control" ID="TextBox8" runat="server" placeholder="Book Description" TextMode="MultiLine" Rows="2" ></asp:TextBox>
                        &nbsp;<div class="form-group">
                        </div>
                     </div>
                  </div>
