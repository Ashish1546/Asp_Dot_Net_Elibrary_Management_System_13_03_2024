    ...
    public partial class AdminBookInventory : System.Web.UI.Page
    {
        ...
        void fillAuthorPublisherValues()
        {
            try
            {
                ...
                DropDownList3.DataValueField = "author_name"; //Column name of the table
                DropDownList3.DataBind();

                // Binding the publisher details
        ...
        void addNewBook()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO [dbo].[book_master_tbl] " +
                "([book_id],[book_name],[genre],[author_name],[publisher_name],[publish_date],[language],[edition],[book_cost], " +
        ...
        void updateBookByID()
        {
            if (checkIfBookExists())
            {
                try
                {
                    //Issued BOOK Related Calculation.
        ...
        void getBookByID()
        {
            try
            {
                ...
                if(dt.Rows.Count >= 1)
                {
                    ...
                    TextBox8.Text = dt.Rows[0]["book_description"].ToString();
