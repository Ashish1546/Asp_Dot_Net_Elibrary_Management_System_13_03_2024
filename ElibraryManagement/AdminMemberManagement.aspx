               ...
               <div class="card-body">                
                     ...
                     <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <asp:LinkButton class="btn btn-primary" ID="LinkButton4" runat="server" Text="S" OnClick="LinkButton4_Click"> 
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox13" runat="server" placeholder="Pin Code" ReadOnly="True"></asp:TextBox>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="row">
                     <div class="col-12">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox14" runat="server" placeholder="Full Postal Address" TextMode="MultiLine" Rows="2" ReadOnly="True"></asp:TextBox>
                        </div>
                     </div>
                  </div>
          ...
          <div class="col-md-6">
              <div class="card shadow">
                  <div class="card-body">                      
                      ...
                      <div class="row">
                          <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ELibrary_DBConnectionString %>" SelectCommand="SELECT * FROM [member_master_tbl]">
                          ...
                          <div class="col">
                              <asp:GridView CssClass="table table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="member_id" DataSourceID="SqlDataSource1">
                                  <Columns>
                                      ...
                                      <asp:BoundField DataField="contact_no" HeaderText="Contatct" SortExpression="contact_no" />
